...
def resnet_mod(base_model, in_channel=6, num_classes=None, pretrained=False):
    '''
    '''
...
def densenet_mod(base_model, in_channel=6, num_classes=None, pretrained=False):
    '''
    '''
    model = base_model(pretrained=pretrained)
    model_name = model.__class__.__name__
...
def enet_mod(model_size=6, in_channel=6, num_classes=None):
    '''
    '''
...
def xception_mod(in_channel=6, num_classes=None, pretrained=False):
    '''
    '''
...
def senet_mod(base_model, in_channel=6, num_classes=None, pretrained=False):
    '''
    '''
